...
*** TODO Load ~/.config/yolo/config if exists
*** TODO Load .yolo.conf from project root if exists
*** TODO Override defaults with config values
*** TODO Support BASE_IMAGE config
*** TODO Support DEFAULT_SHELL config
*** TODO Support custom pass paths
